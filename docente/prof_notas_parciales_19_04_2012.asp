...
End If%>
                <select name="CarreraAsignatura" class="SELECT" id="CarreraAsignatura" onChange="MM_jumpMenu('parent',this,0)" select>
                  <option value="prof_notas_parciales.asp?s_StringAsigCarrera=<%=n_CdAsigna&"*"&n_NrProceMapaes&"*"&s_NmAsigna&"*"&s_TipoAsig&"*"&n_NrParalelo&"*"&"0"&"*"&s_CdClave1&"*"&d_FcAsistencia%>" selected>Todas las Carrera:</option>
                  <% If n_NrParalelo > 0 Then
