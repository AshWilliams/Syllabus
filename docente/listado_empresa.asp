  ...
  <tr> 
    ...
    <td width="760" valign="top"> 
      <table width="760" border="0" cellpadding="0" cellspacing="5">
        ...
        <tr> 
          <td valign="top"><span class="txtitulo">eMPRESAS aCTIVAS POR CARRERAS </span><br> 
              ...
              <tr>
                <td><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  ...
                  <select name="carrera" class="SELECT" id="carrera" onChange="MM_jumpMenu('parent',this,0)">
                    ...
                    <option value="listado_empresa.asp?s_CdCarrera=<%= CStr(valor(LIST_CARRERA,"s_CdCarrera"))&"*"&(valor(LIST_CARRERA,"s_NmCarrera"))%>"<%If (Not isNull((n_CdCarrera))) Then If (valor(LIST_CARRERA,"s_CdCarrera") = CStr((n_CdCarrera))) Then Response.Write("SELECTED") : Response.Write("")%>><%= valor(LIST_CARRERA,"s_NmCarrera")%></option>
                    <% set LIST_CARRERA = CARRERA.nextnode
                             wend %>
                  </select>                </td>
              </tr>
			...
			<% if n_CdCarrera <> 0 then 
                          xml = o.Listado_Empresas(n_CdCarrera) 
                          Set doc = Server.CreateObject ("MSXML.DomDocument")
                          Call doc.loadxml (xml)
                          set EMPRESA = doc.selectNodes("//EMPRESA/LIST_EMPRESA") 
                          %>
            <table width="750" border="1" cellpadding="1" cellspacing="0" bordercolor="#999999">
              <tr bgcolor="#666666"> 
                <td colspan="4" class="texto"><font color="#FFFFFF"><strong>Listado de Empresas </strong></font></td>
              </tr>
              <tr bgcolor="#CCCCCC" class="texto"> 
                <td width="215"> <div align="center"><strong></strong></div>                  
                  <strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif">                </font>Empresa</strong></td>
                <td width="20"> <div align="center"><strong>N&ordm;</strong></div></td>
                <td width="229"> <div align="center"><strong>Nombre</strong></div></td>
                <td width="268"> <div align="center"><strong>Cargo</strong></div></td>
              </tr>
			  <%'n_NrSw=0
					    'n_NrContador=1
						set LIST_EMPRESA= EMPRESA.nextNode
						while not (LIST_EMPRESA is nothing)
%>
              <tr class="texto"> 
                <td><div align="center"><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
                </font></span></div><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
                 <%response.write(valor(LIST_EMPRESA,"s_NmEmpresa"))%>
                </font></span></td>
                <td><div align="right"></div>
                  <div align="right"><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
                    <%response.write (valor(LIST_EMPRESA,"s_NrContador"))%>
                  </font></span></div></td>
                <td><div align="left"><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
                    <%response.write (valor(LIST_EMPRESA,"s_NmEgresado"))%>
                </font></span></div></td>
                <td><div align="left"><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
                    <%response.write (valor(LIST_EMPRESA,"s_NmCargo"))%>&nbsp;
                </font></span></div></td>
              </tr>
			  <% set LIST_EMPRESA= EMPRESA.nextNode
