          ...
          <td valign="top"><div align="center">
            <table width="570" height="100%" border="0" cellpadding="0" cellspacing="5">
                ...
                <tr> 
				  ...
				  <%End If%> <img src="img/cert_boletas.jpg" width="550" height="150"></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td><table width="185" border="0" cellspacing="2" cellpadding="0">
                    <tr>
                      <td width="60"><span class="homearea"><a href="../ca2011.pdf" target="_blank"><img src="img/bt_calendario.jpg" name="circulo4" width="60" height="60" border="0" align="left" id="f1" onMouseOver="MM_swapImage('circulo4','','img/ir.jpg',1)" onMouseOut="MM_swapImgRestore()"></a></span></td>
                      <td><span class="homearea">Calendario Acad&eacute;mico</span><br>
