  ...
  <tr> 
    ...
    <td width="760" valign="top"> 
      <table width="760" border="0" cellpadding="0" cellspacing="5">
        ...
        <tr> 
          <td valign="top"><span class="txtitulo">Titulados con postgrado</span><br> 
              ...
              <tr>
                <td><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  ...
                  <select name="carrera" class="SELECT" id="carrera" onChange="MM_jumpMenu('parent',this,0)">
                    ...
                    <option value="titulado_postgrado.asp?s_CdCarrera=<%= CStr(valor(LIST_CARRERA,"s_CdCarrera"))&"*"&(valor(LIST_CARRERA,"s_NmCarrera"))%>"<%If (Not isNull((n_CdCarrera))) Then If (valor(LIST_CARRERA,"s_CdCarrera") = CStr((n_CdCarrera))) Then Response.Write("SELECTED") : Response.Write("")%>><%= valor(LIST_CARRERA,"s_NmCarrera")%></option>
                    <% set LIST_CARRERA = CARRERA.nextnode
                             wend %>
                  </select></td>
              </tr>
            ...
            <strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
              ...
              <tr>
                <td><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  <% 
                          xml = o.Consulta_Tit_Postgrado(n_CdCarrera, n_NrPorcentage) 
                          Set doc = Server.CreateObject ("MSXML.DomDocument")
                          Call doc.loadxml (xml)
              ...
              <tr>
                <td><span class="homearea"><strong>% de Titulados con Postgrado: </strong></span><strong>&nbsp;&nbsp;</strong><span class="respuesta"><%=(n_NrPorcentage)%> </span></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
            ...
            <table width="750" border="1" cellpadding="1" cellspacing="0" bordercolor="#999999">
              <tr bgcolor="#666666"> 
                <td colspan="4" class="texto"><font color="#FFFFFF"><strong>Titulados con Postgrado </strong></font></td>
              </tr>
              <tr bgcolor="#CCCCCC" class="texto"> 
                ...
                <td> <div align="center"><strong>Postgrado</strong></div></td>
              </tr>
			  <%n_NrSw=0
					    n_NrContador=1
...
%>
              <tr class="texto"> 
                <td><div align="center"><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
                  <%response.write (n_NrContador)%></font></span></div></td>
                <td><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
                 <%response.write(valor(LIST_ALUMNO,"s_NmNombres"))%></font></span></td>
                <td><div align="center"><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
                    <%response.write (valor(LIST_ALUMNO,"s_NrRutAlu"))%>
                </font></span></div></td>
                <td><div align="left"></div>
                  <div align="left"><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
