...
<table width="950" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    ...
    <td width="570" valign="top"> 
	  ...
	  <form action="prof_lista_curso.asp" method="post" name="form1">
        <tr> 
...
<% call response.write (s_NmBrsProfe) %>
        ...
        <tr> 
          <td valign="top"><table width="560"  border="0" cellspacing="0" cellpadding="2">
            <tr>
              <th colspan="3" scope="col"><div align="right" class="texto">
                  <div align="right"></div>
              </div>                
              <div align="left" class="txtitulo">Lista de Curso</div></th>
              </tr>
            <tr>
              <th width="14%" scope="col">&nbsp;</th>
              <th width="19%" scope="col"><div align="right"><span class="texto"><strong>Asignatura:</strong></span></div></th>
              <th width="67%" scope="col"><div align="left"><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif">
            ...
            <tr>
              <td>&nbsp;</td>
              <td><div align="right"><span class="texto"><strong>Tipo:</strong></span></div></td>
              <td><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif">
                ...
                <select name="TipoAsignatura" class="SELECT" id="TipoAsignatura" onChange="MM_jumpMenu('parent',this,0)" select>
                  <option value="prof_Lista_Curso.asp" selected>Elija Tipo Asignatura:</option>
                  <%' If s_NmAsigna <> "" Then
				        set TIPOASIG= LISTA.nextNode
                       while not (TIPOASIG is nothing) %>
                  <option value="prof_Lista_Curso.asp?s_StringAsigTipo=<%=CStr(n_CdAsigna)&"-"&s_NmAsigna&"-"&valor(TIPOASIG,"s_TipoAsig")%>" <%If (s_TipoAsig<>"") Then If (valor(TIPOASIG,"s_TipoAsig") = s_TipoAsig) Then Response.Write("SELECTED") : Response.Write("")%>><%= valor(TIPOASIG,"s_TipoAsig") %></option>
                  <%    set TIPOASIG= LISTA.nextNode
							wend
					    ' End If %>
                </select>
            ...
            <tr>
              <td>&nbsp;</td>
              <td><div align="right"><span class="texto"><strong>Paralelo:</strong></span></div></td>
              <td><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif">
                <%' If s_TipoAsig <> "" Then
                ...
                <select name="ParaleloAsignatura" class="SELECT" id="ParaleloAsignatura" onChange="MM_jumpMenu('parent',this,0)" select>
                  <option value="prof_Lista_Curso.asp" selected>Elija el Paralelo:</option>
                  <%' If s_TipoAsig <> "" Then
					   set PARALELO= LISTA.nextNode 
                       while not (PARALELO is nothing)%>
                  <option value="prof_Lista_Curso.asp?s_StringAsigParalelo=<%=n_CdAsigna&"-"&s_NmAsigna&"-"&s_TipoAsig&"-"&valor(PARALELO,"s_NrParalelo")%>" <%If (Not isNull((n_NrParalelo))) Then If (valor(PARALELO,"s_NrParalelo") = CStr((n_NrParalelo))) Then Response.Write("SELECTED") : Response.Write("")%>><%= valor(PARALELO,"s_NrParalelo")%></option>
                  <%   set PARALELO= LISTA.nextNode
					    wend
				'        End If%>
                </select>
            ...
            <tr>
              <td>&nbsp;</td>
              <td><div align="right"><span class="texto"><strong>Filtre por:</strong></span></div></td>
              <td><span class="Estilo13"><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif">
                ...
                <select name="CarreraAsignatura" class="SELECT" id="CarreraAsignatura" onChange="MM_jumpMenu('parent',this,0)" select>
                  <option value="prof_Lista_Curso.asp?s_StringAsigCarrera=<%=n_CdAsigna&"-"&s_NmAsigna&"-"&s_TipoAsig&"-"&n_NrParalelo&"-"&"0"%>" selected>Todas las Carreras:</option>
                  <%'If n_NrParalelo > 0 Then
		            set CARRERA= LISTA.nextNode 
                    while not (CARRERA is nothing)%>
                  <option value="prof_Lista_Curso.asp?s_StringAsigCarrera=<%=n_CdAsigna&"-"&s_NmAsigna&"-"&s_TipoAsig&"-"&n_NrParalelo&"-"&valor(CARRERA,"s_CdCarrera")%>" <%If (Not isNull((n_CdCarrera))) Then If (valor(CARRERA,"s_CdCarrera") = CStr((n_CdCarrera))) Then Response.Write("SELECTED") : Response.Write("")%>><%= valor(CARRERA,"s_NmCarrera")%></option>
                  <% set CARRERA= LISTA.nextNode
					 wend
					'End If%>
                </select>
            ...
            <tr>
              <td colspan="3"><table width="560" border="1" cellpadding="1" cellspacing="0" bordercolor="#999999">
                <tr bgcolor="#666666">
                  <td colspan="3" class="texto"><font color="#FFFFFF"><strong>Lista de Curso </strong></font></td>
                </tr>
                <tr bgcolor="#CCCCCC" class="texto">
                  <td width="27"><div align="center"><strong>N&ordm;</strong></div></td>
                  <td width="102"><div align="center"><strong>Rut Alumno </strong></div></td>
                  <td><div align="center"><strong>Nombre del Alumno </strong></div>                    <div align="center"></div></td>
                  </tr>
                ...
                <tr class="texto">
                  ...
                  <td><div align="left"><%= valor(CURSO,"s_NrRutAluDv")%></div></td>
                  <td><div align="left"><%= valor(CURSO,"s_NmAlumno")%></div>
