...
<%  Dim o, doc, xml, ASIGNATURAS, LISTAASIGNATURAS, ALUMNOS, ASISTENCIA, n_NrRutProfe, n_NrAnoActivo, n_NrPerActivo, s_NmBrsProfe, d_FcSistema, s_StringAsig, s_CdCarrer,s_NrMalla, s_NrParale, s_CdAsigna, s_NmCarrer, s_NmAsigna, n_Sw, n_NrContador, s_NrRutAluDv, s_NmAlumno, s_NrOportu, s_VlNotaPr, s_VlNotaEx, s_VlNotaTc, s_NotaConcepto, s_GlNotaCo
	...
	s_TpPerfil = "D"
	n_NrRegistro = CInt(Request("s_StrModificaCom"))
	Call o.Consulta_Comunicado_Mod(n_NrRegistro, s_TpPerfil, s_Activo, s_Index, s_Perfil, s_Titulo, s_Resumen, l_Texto)
...
<table width="950" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    ...
    <td width="570" valign="top"> 
	  ...
	  <form action="prof_modifica_com_globales_eje.asp" method="post" name="form1">
        <tr> 
...
&nbsp;</strong>&nbsp; </span><span class="texto">Fecha:</span><span class="respuesta Estilo2">
        ...
        <tr> 
          <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr class="texto">
              <td width="20%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><font size="2" face="Arial, Helvetica, sans-serif">
                <input name="n_NrRegistro" type="hidden" id="n_NrRegistro" value="<%=(n_NrRegistro) %>">
</font><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><font size="2" face="Arial, Helvetica, sans-serif">

</font></font></font><font size="2" face="Arial, Helvetica, sans-serif">              </font><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif">
              </font></font></font></td>
              <td width="23%">Activado
                <select name="Activado" class="SELECT" id="Activado">
                  <option value="S" <%If s_Activo = "S" Then%>selected><%else%>><%End If%>SI</option>
                  <option value="N"<%If s_Activo = "N" Then%>selected><%else%>><%End If%>NO</option>
                </select></td>
              <td width="23%">Index: 
                <select name="Index" class="SELECT" id="Index">
                  <option value="S" <%If s_Index = "S" Then%>selected><%else%>><%End IF%>SI</option>
                  <option value="N" <%If s_Index = "N" Then%>selected><%else%>><%End IF%>NO</option>
                </select></td>
              <td width="34%">Tipo Perfil: 
                <select name="Perfil" class="SELECT" id="Perfil">
                  <option value="A"<%If s_Perfil = "A" Then%>selected><%else%>><%End If%>ALUMNO</option>
                  <option value="D"<%If s_Perfil = "D" Then%>selected><%else%>><%End If%>DOCENTE</option>
                </select></td>
            </tr>
          </table>
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="8%" class="texto"><div align="right">Titulo</div></td>
                <td width="45%">&nbsp;</td>
                <td width="47%">&nbsp;</td>
              </tr>
              <tr>
                <td colspan="3"><input name="Titulo" type="text" class="input" id="Titulo" value="<%=(s_Titulo)%>" size="80" maxlength="40"></td>
                </tr>
              <tr>
              ...
              <tr>
                <td colspan="3"><input name="Resumen" type="text" class="input" id="Resumen" value="<%=(s_Resumen)%>" size="90" maxlength="90"></td>
                </tr>
              <tr>
                <td colspan="2">&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td><div align="right">
                  <input name="accion" type="submit" class="input" id="accion" value="Modificar">&nbsp;
                </div></td>
                <td>&nbsp;<input name="accion" type="submit" class="input" id="accion" value="Volver"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td colspan="2" valign="top"><textarea name="Texto" cols="120" rows="40" class="input" id="Texto"><%=(l_Texto)%></textarea></td>
                </tr>
              <tr>
                <td colspan="3"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="50%">&nbsp;<input name="accion" type="submit" class="input" id="accion" value="Volver"></td>
                  </tr>
                </table></td>
                </tr>
              <tr>
