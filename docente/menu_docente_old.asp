    ...
    <td><ul>
        <li><img src="../img/flechamenu.jpg" width="5" height="6"><a href="#"  class="estilo2" onclick="despliega();return false;"><strong> 
          ...
          <ul id="Gesacademica">
			...
			<li><a href="prof_Acta_Formacion_General.asp" class="estilo2">Actas de Formación General</a></li>
            ...
            <li><a href="http://www.uvm.cl/calendarioacad.htm" target="_blank" class="estilo2">Calendario Acad&eacute;mico</a></li>
        ...
        <li><img src="../img/flechamenu.jpg" width="5" height="6"><a href="#"  class="estilo2" onclick="despliega2();return false;"><strong> 
          ...
          <ul id="Serdocente">
            ...
            <li><a href="boleta.asp" class="estilo2">Generar Boleta</a></li>
            <li><a href="historico_boletas.asp" class="estilo2">Historial de Boletas</a></li>
          </ul>
        </li>
        <hr size="1" noshade color="ff0000">
        ...
        <li><img src="../img/flechamenu2.jpg" width="5" height="6"><a href="http://biblioteca.uvm.cl/biblioteca.asp" target="_blank"  class="estilo2" ><strong> 
        ...
        <li><img src="../img/flechamenu.jpg" width="5" height="6"><a href="#"  class="estilo2" onclick="despliega3();return false;"><strong> 
          ...
          <ul id="otrosSer">
            <li><a href="http://www.uvm.cl/buses.htm" target="_blank" class="estilo2">Horario Buses</a></li>
