    ...
    <td width="570" valign="top"> 
      <table width="570" border="0" cellpadding="0" cellspacing="5">
        <form enctype="application/x-www-form-urlencoded" method="post"  name="form_ingreso" id="form_ingreso" >
          ...
          <tr> 
            <td valign="top" class="txsubtitulo">Reglamentos</td>
          </tr>
          <tr> 
            <td valign="top">&nbsp;</td>
          </tr>
          <tr> 
            <td valign="top"><a href="../docs/reg_acad08.pdf" target="_blank">Reglamento 
              General Acad&eacute;mico</a></td>
          </tr>
          <tr>
            <td valign="top"><a href="documentos/admin_docente.pdf" target="_blank">Reglamento 
              de Administraci&oacute;n Docente</a></td>
          </tr>
          <tr> 
            <td valign="top"><a href="../docs/deb_der.pdf" target="_blank">Deberes 
              y Derechos de los Alumnos UVM</a></td>
          </tr>
          <tr>
            <td valign="top"><a href="../docs/Reglamento_convalidacion.pdf" target="_blank">Reglamento de Convalidaci&oacute;n, Homologaci&oacute;n y Validaci&oacute;n de Conocimientos</a></td>
          </tr>
          <tr> 
            <td valign="top">&nbsp;</td>
          </tr>
