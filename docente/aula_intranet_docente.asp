  ...
  <tr>
    <td><table border="0" align="center" cellpadding="0" cellspacing="10">
        <tr>
          ...
          <a href="docente_aula_eje.asp" target="_parent">
          		<img src="img/aula_asignaturas2.gif" name="asig" width="201" height="122" border="0" id="asig" onMouseOver="MM_swapImage('asig','','img/aula_asignaturas.gif',1)" onMouseOut="MM_swapImgRestore()">
          </a></td>
          <td valign="top"> 
            <table width="536" border="1" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC">
              ...
              <tr>
                <td bgcolor="#FFFFFF">
					<p><iframe src="https://www.uvm.cl/pruebaaula/home.shtml" width="530" height="340" frameborder="0"></iframe>
                    </p>
				<!-- <p>&nbsp;</p>
				<p>&nbsp;</p>
                ...
                <td bordercolor="#CCCCCC"> 
                  <table border="0" align="center" cellpadding="0" cellspacing="10">
                    ...
                    <tr> 
                      ...
                      <td><a href="http://www.uvm.cl/biblioteca/nuevopac.htm" target="_blank"><img src="img/aula_biblio1.gif" name="biblio" width="58" height="76" border="0" id="biblio" onMouseOver="MM_swapImage('biblio','','img/aula_biblio2.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
                    </tr>
                    <tr> 
