...
&nbsp;</strong>&nbsp; </span><span class="texto">Fecha:</span><span class="respuesta Estilo2">
        ...
        <tr> 
          <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td colspan="3" class="txsubtitulo">Si falta alguna actividad, es porque no est&aacute; programada o no tiene el número m&iacute;nimo de pruebas, comun&iacute;quese con su Jefatura de Carrera.
