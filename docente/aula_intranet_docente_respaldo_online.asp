...
<table width="990" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table border="0" align="center" cellpadding="0" cellspacing="10">
        <tr>
          <td height="20" valign="top"><a href="docente_aula_eje.asp"><img src="img/aula_asignaturas2.gif" name="asig" width="201" height="122" border="0" id="asig" onMouseOver="MM_swapImage('asig','','img/aula_asignaturas.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
          <td valign="top"> 
            <table width="536" border="1" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC">
              ...
              <tr>
                <td bgcolor="#FFFFFF">
					<iframe src="http://www.uvm.cl/pruebaaula/home.shtml" width="530" height="340" frameborder="0"></iframe></td>
              </tr>
            </table><p>&nbsp;</p></td>
          <td valign="top">
