...
<% call response.write (s_NmBrsProfe) %> 
        ...
        <tr>
          <td colspan="2" valign="top"><iframe src="https://apc.uvm.cl/apc/slice.php3?slice_id=eccec5cc3dbc3966af7325c8135dae6e" width="550" height="50" frameborder="0" scrolling="no" marginwidth="0" marginheight="0"></iframe></td>
        </tr>
        <tr>
