...
<table width="950" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    ...
    <td width="731" valign="top"> 
	  ...
	  <form action="prof_prb_consulta_asig_np.asp" method="post" name="form1">
        <tr> 
...
&nbsp;</strong>&nbsp; </span><span class="texto">Fecha:</span><span class="respuesta Estilo2">
        ...
        <tr> 
          <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td colspan="3" class="txtitulo">Consulta notas parciales</td>
              </tr>
            <tr>
            ...
            <tr>
			  ...
			  dim CARGA_DOCENTE, LIST_CARGA_DOCENTE
				...
				xml = o.Prb_Consulta_Asignaturas_ListaPrueba_Profesor(n_NrRutProfe)
                ...
                <tr class="texto">
                  ...
                  <td align="left"><a href="prof_prb_ListaNotas.asp?s_CdPrb=<%=CStr(valor(LIST_CARGA_DOCENTE,"s_CdCarrera"))&"*"&valor(LIST_CARGA_DOCENTE,"s_NmCarrera")&"*"&valor(LIST_CARGA_DOCENTE,"s_NrAnoPrueba")&"*"&valor(LIST_CARGA_DOCENTE,"s_NrPerPrueba")&"*"&valor(LIST_CARGA_DOCENTE,"s_NrMalla")&"*"&valor(LIST_CARGA_DOCENTE,"s_TipoAsig")&"*"&valor(LIST_CARGA_DOCENTE,"s_NrParalelo")&"*"&valor(LIST_CARGA_DOCENTE,"s_Activo")&"*"&valor(LIST_CARGA_DOCENTE,"s_CdRegimen")&"*"&valor(LIST_CARGA_DOCENTE,"s_CdAsigna")&"*"&valor(LIST_CARGA_DOCENTE,"s_NrPruebasMin")&"*"&valor(LIST_CARGA_DOCENTE,"s_PrPruebas")&"*"&valor(LIST_CARGA_DOCENTE,"s_NmAsigna")%>"><%= valor(LIST_CARGA_DOCENTE,"s_NmAsigna") %></a></td>
            ...
            <tr>
              <td colspan="3" class="txsubtitulo"><div align="left"><span class="respuesta">Si falta alguna actividad es por qu&eacute; no est&aacute; programada o no tiene evaluaciones creadas, ante alguna duda comun&iacute;quese con su Jefe de Carrera </span></div></td>
            </tr>
