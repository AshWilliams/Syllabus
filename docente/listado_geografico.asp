      ...
      <table width="760" border="0" cellpadding="0" cellspacing="5">
        ...
        <tr> 
          <td valign="top"><span class="txtitulo">Titulados por carreras </span><br> 
              ...
              <tr>
                <td><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  ...
                  <select name="carrera" class="SELECT" id="carrera" onChange="MM_jumpMenu('parent',this,0)">
                    ...
                    <option value="listado_geografico.asp?s_CdCarrera=<%= CStr(valor(LIST_CARRERA,"s_CdCarrera"))&"*"&(valor(LIST_CARRERA,"s_NmCarrera"))%>"<%If (Not isNull((n_CdCarrera))) Then If (valor(LIST_CARRERA,"s_CdCarrera") = CStr((n_CdCarrera))) Then Response.Write("SELECTED") : Response.Write("")%>><%= valor(LIST_CARRERA,"s_NmCarrera")%></option>
                    <% set LIST_CARRERA = CARRERA.nextnode
                             wend %>
                  </select>                </td>
              </tr>
			...
			<% if n_CdCarrera <> 0 then 
                          xml = o.listado_geografico(n_CdCarrera) 
                          Set doc = Server.CreateObject ("MSXML.DomDocument")
                          Call doc.loadxml (xml)
                          set ZONA = doc.selectNodes("//ZONA/LIST_ZONA") 
                          %>
            <table width="750" border="1" cellpadding="1" cellspacing="0" bordercolor="#999999">
              <tr bgcolor="#666666"> 
                <td colspan="5" class="texto"><font color="#FFFFFF"><strong>Distribuci&oacute;n Zona Geogr&aacute;fica </strong></font></td>
              </tr>
              <tr bgcolor="#CCCCCC" class="texto"> 
                <td width="140"> <div align="center"><strong>Regi&oacute;n</strong></div>                  </td>
                <td width="101"> <div align="center"><strong>Ciudad</strong></div></td>
                <td width="168"> <div align="center"><strong>Empresa</strong></div></td>
                <td width="171"> <div align="center"><strong>Nombre</strong></div></td>
                <td width="148"><strong>Cargo</strong></td>
              </tr>
			  <%'n_NrSw=0
					    'n_NrContador=1
						set LIST_ZONA= ZONA.nextNode
						while not (LIST_ZONA is nothing)
%>
              <tr class="texto"> 
                <td class="texto"><div align="center"><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
                  </font></span><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
				  <%response.write(valor(LIST_ZONA,"s_NmRegion"))%>
                </font></span></div>                  
                </td>
                <td class="texto"><div align="right"></div>
                  <div align="right"><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
                    <%response.write (valor(LIST_ZONA,"s_NmCiudad"))%>
                </font></span></div></td>
                <td class="texto"><div align="center"><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
                  <%response.write (valor(LIST_ZONA,"s_NmEmpresa"))%>
                </font></span></div></td>
                <td class="texto"><div align="center"><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
                  <%response.write (valor(LIST_ZONA,"s_NmEgresado"))%>
                </font></span></div></td>
                <td><span class="Estilo4"><font size="1" face="Arial, Helvetica, sans-serif">
                  <%response.write (valor(LIST_ZONA,"s_NmCargo"))%>&nbsp;
                </font></span></td>
              </tr>
			  <% set LIST_ZONA= ZONA.nextNode
