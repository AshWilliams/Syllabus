          ...
          <td valign="top"><div align="center">
            <table width="570" height="100%" border="0" cellpadding="0" cellspacing="5">
                ...
                <tr> 
                  <td><table width="185" border="0" cellspacing="2" cellpadding="0">
                    <tr>
                      <td width="60"><span class="homearea"><a href="../alumno/calendarioacademico.pdf" target="_blank"><img src="img/bt_calendario.jpg" name="circulo4" width="60" height="60" border="0" align="left" id="f1" onMouseOver="MM_swapImage('circulo4','','img/ir.jpg',1)" onMouseOut="MM_swapImgRestore()"></a></span></td>
                  ...
                  <td valign="top"><table width="185" border="0" cellspacing="2" cellpadding="0">
                    <tr>
                      <td width="60"><span class="homearea"><a href="../alumno/calendariovespertino.pdf" target="_blank"><img src="img/bt_calendario.jpg" name="circ4" width="60" height="60" border="0" align="left" id="f1" onMouseOver="MM_swapImage('circ4','','img/ir.jpg',1)" onMouseOut="MM_swapImgRestore()"></a></span></td>
                  ...
                  <td valign="top"><table width="185" border="0" cellspacing="2" cellpadding="0">
                    <tr>
                      <td width="60"><span class="homearea"><a href="documentos/c_carac_admision2012.pdf" target="_blank"><img src="img/bt_form.jpg" name="f22" width="59" height="59" border="0" align="left" id="f22" onMouseOver="MM_swapImage('f22','','img/ir.jpg',1)" onMouseOut="MM_swapImgRestore()"></a></span></td>
                      <td><span class="homearea">Cuestionario Caracterizaci&oacute;n 2012</span><br>
                        <span class="homeintrod">Cuestionario Caracterizaci&oacute;n Admisi&oacute;n 2012</span></td>
                    </tr>
                  </table></td>
                </tr>
                <tr> 
                  ...
                  <td valign="top">
                    <div align="right">
                      <table width="185" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
                          <td width="60"><span class="homearea"><a href="syllabus/index.asp" target="_self"><img src="img/bt_form.jpg" name="syllabus41" width="59" height="59" border="0" align="left" id="syllabus" onMouseOver="MM_swapImage('syllabus41','','img/ir.jpg',1)" onMouseOut="MM_swapImgRestore()"></a></span></td>
                          <td><span class="homearea">Syllabus</span><br>
                            <span class="homeintrod">Administraci&oacute;n Syllabus 
                            </span></td>
                        </tr>
                      </table>
                    </div>
