    ...
    <td><ul>
        <li><img src="../img/flechamenu.jpg" width="5" height="6"><a href="#"  class="estilo2" onClick="despliega();return false;"><strong> 
          ...
          <ul id="Gesacademica">
            ...
            <li><a href="../alumno/calendarioacademico.pdf" target="_blank" class="estilo2">Calendario 
              Acad&eacute;mico (d)</a></li> 
              <li><a href="../alumno/calendariovespertino.pdf" target="_blank"class="estilo2">Calendario 
              Acad&eacute;mico (v)</a></li>
            <li><a href="prof_lista_curso.asp" class="estilo2">Listas de Curso</a></li>
            <li><a href="prof_prb_consulta_asig.asp" class="estilo2">Creación de Pruebas</a></li> 
            <li><a href="prof_notas_parciales.asp" class="estilo2">Registro Notas Parciales</a></li>
            <li><a href="prof_prb_consulta_asig_np.asp" class="estilo2">Consulta Notas Parciales</a></li>
            <li><a href="prof_acta_consulta_asig.asp" class="estilo2">Registro Notas de Actas</a></li>
        ...
        <li><img src="../img/flechamenu.jpg" width="5" height="6"><a href="#"  class="estilo2" onClick="despliega2();return false;"><strong> 
          ...
          <ul id="Serdocente">
            ...
            <li><a href="Prof_lista_evaluacion.asp" class="estilo2">Informe Evaluación</a></li>
          </ul>
        </li>
        <hr size="1" noshade color="ff0000">
        ...
        <li><img src="../img/flechamenu.jpg" width="5" height="6"><a href="#"  class="estilo2" onClick="despliega4();return false;"><strong> 
          ...
          <ul id="Comunicados">
		    <li><a href="http://www.uvm.cl/uvm/mas_agenda.shtml" target="_blank" class="estilo2">Agenda UVM </a></li>
            <li><a href="prof_com_globales.asp" class="estilo2">Comunicados</a></li>
            <li><a href="http://www.uvm.cl/uvm/mas_noticias.shtml" target="_blank" class="estilo2">Noticias Generales </a></li>
        ...
        <li><img src="../img/flechamenu.jpg" width="5" height="6"><a href="#"  class="estilo2" onClick="despliega3();return false;"><strong> 
          ...
          <ul id="otrosSer">
            <li><a href="http://www.uvm.cl/servicios/buses.shtml" target="_blank" class="estilo2">Horario Buses</a></li>
