...
&nbsp;</strong>&nbsp; </span><span class="texto">Fecha:</span><span class="respuesta Estilo2">
        ...
        <tr> 
          <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td colspan="3" class="txtitulo">Comunicados</td>
              </tr>
            <tr>
            ...
            <tr>
              <td width="35%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif">
                <% 
		n_NrMarca = 0  ' 0 para que se vean todos los mensajes activos
...
%>
              ...
              <td width="58%"><%If n_NrRutProfe = 11736758 or n_NrRutProfe = 13194243 Then%><input name="accion" type="submit" id="accion" value="Nuevo Comunicado"><%End If%></td>
              <td width="7%">
			  <%if request("accion") = "Nuevo Comunicado" then
			   		response.redirect("prof_com_globales_nuevo.asp")
				End If%></td>
            </tr>
            <tr>
            ...
            <table width="560" border="1" cellpadding="1" cellspacing="0" bordercolor="#999999">
              <tr bgcolor="#666666">
                <td colspan="3" class="texto"><font color="#FFFFFF"><strong>Comunicados Globales </strong></font></td>
              </tr>
              <tr bgcolor="#CCCCCC" class="texto">
                <td width="60"><div align="center"><strong>Fecha</strong></div></td>
                <td width="424"><div align="center"><strong>Asunto</strong></div></td>
                <td width="62"><div align="center"><strong>Detalle</strong></div>                  <div align="center"></div>                  <div align="center"></div>                  <div align="center"></div>                  <div align="center"></div>                  <div align="center"></div>                  <div align="center"></div></td>
                </tr>
			  <% set REGISTRO= AGENDA.nextNode
			while not (REGISTRO is nothing)%>
              <tr class="texto">
                <td><div align="center"><%= valor(REGISTRO,"s_FcRegistro")%></div></td>
                <td><div align="left"><font size="1" face="Arial, Helvetica, sans-serif"><%'If n_NrRutProfe = 13194243 Then%><!--<a href="prof_modifica_com_globales.asp?s_StrModificaCom=<%'=CStr(valor(REGISTRO,"s_NrRegistro"))%>"> -->
				<%= valor(REGISTRO,"s_TpAsunto")%><!--</a>--><%'Else response.write(valor(REGISTRO,"s_TpAsunto")) End IF%>
				</font></div></td>
                <td><div align="left"><a href="prof_com_globales_detalle.asp?n_NrRegistro=<%= valor(REGISTRO,"s_NrRegistro")%>&s_Fecha=<%=valor(REGISTRO,"s_FcRegistro")%>&s_Asunto=<%=valor(REGISTRO,"s_TpAsunto")%>">&nbsp;<em>Ver Detalle</em></a></div></td>
                </tr>
			  <% set REGISTRO= AGENDA.nextnode
			 	 wend
